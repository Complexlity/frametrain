...
//       inputText:
//         airstackPayloadValidated.message.data.frameActionBody.inputText ||
//         undefined,
//       state:
//         airstackPayloadValidated.message.data.frameActionBody.state ||
//         undefined,
//       transactionHash:
//         airstackPayloadValidated.message.data.frameActionBody.transactionId ||
//         undefined,
//       castFid:
//         airstackPayloadValidated.message.data.frameActionBody.castId.fid.toString(),
//       castHash:
//         airstackPayloadValidated.message.data.frameActionBody.castId.hash,
//       createdAt: new Date(),
//     })
//     .run();
// }
